...
classNames = []
classFile = r"E:\AAIC\Conveyor_Belt\Object_Detection_Files\coco.names"
with open(classFile,"rt") as f:
    classNames = f.read().rstrip("\n").split("\n")

#This is to pull the information about what each object should look like
configPath = r"E:\AAIC\Conveyor_Belt\Object_Detection_Files\ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt"
weightsPath = r"E:\AAIC\Conveyor_Belt\Object_Detection_Files\frozen_inference_graph.pb"
